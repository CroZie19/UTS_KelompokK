        ...
        <table class="table">
            ...
            <form action="../process/editRequestProcess.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="penulis" name="penulis" value="<?php echo $d['penulis']; ?>" >
                </div>
                <div class="mb-3">
                    <label for="tahun_rilis" class="form-label">Tahun Rilis</label>
                    <input class="form-control" id="tahun_rilis" name="tahun_rilis" value="<?php echo $d['tahun_rilis']; ?>" >
                </div>
